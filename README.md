...
This project demonstrates how a simple backend can turn raw CSV data into a useful retail transaction API. This is about learning data parsing, Node.js server design, and basic API routing.
